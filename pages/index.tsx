...
const IndexPage = () => (
  <Layout title="Earn Arcade">
    <div className='w-full md:w-11/12 mx-auto px-2 pt-6'>
      ...
      <p className='text-xl md:text-2xl pt-8'>Follow <a className='text-blue-500 border-b-2 border-blue-500' href="https://twitter.com/davidhurley87" target="_blank">@davidhurley87</a> for the latest.</p>
    </div>
  </Layout>
)
